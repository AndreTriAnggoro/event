    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="start_datetime"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date and Time</label>
            ...
            <form method="POST" action="{{ route('tags.store') }}" class="mb-4">
                ...
                <div>
                    <label for="new_tag"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New Tag</label>
                ...
                <div>
                    <button type="submit" name="action" value="create_tag"
                        class="text-gray-600 hover:text-gray-800 focus:outline-none">Create Tag</button>
                </div>
            </form>
...
<script>
    function updateCities() {
        ...
        if (countrySelect.value !== '') {
            axios.get(`/countries/${countrySelect.value}`).then(function(response) {
